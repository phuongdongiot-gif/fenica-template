...
<footer class="w-full py-16 relative z-10 border-t border-white/20 bg-transparent text-white" data-aos="fade-up"
    ...
    <div class="max-w-[1200px] mx-auto px-4 md:px-8">
        ...
        <div class="flex flex-col items-center justify-center pt-8 text-center mt-12 border-t border-white/20">
            ...
            <div class="slide-left w-full flex justify-center">
                <div class="w-1/3 py-2">
                    <img src="https://atsaigonriverside.vn/wp-content/themes/dxmd/assets/images/logos/logo-dxmd-dx.png"
                        alt="Ảnh dự án 3" class="w-full h-auto object-cover" loading="lazy">
                </div>
            </div>
            <p class="text-lg md:text-xl font-bold uppercase playfair tracking-widest mb-4 text-white">Liên kết
            </p>
            <style>
            ...
            if (has_nav_menu('footer_menu')) {
                ...
                <nav class="footer-links-menu">
                    <ul>
                        ...
                        <li><a href="<?php echo home_url('/quy-che-hoat-dong'); ?>">Quy chế hoạt động</a></li>
                    </ul>
                </nav>
            <?php } ?>
        </div>
