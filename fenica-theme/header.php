...
<body <?php body_class('min-h-screen bg-[#0e1e2e] overflow-hidden'); ?>>
    ...
    <?php else: ?>
        ...
        <div id="child-preloader-wrap"
            style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; z-index: 9999; background-color: #0e1e2e; pointer-events: none; transition: opacity 0.8s ease-out, visibility 0.8s ease-out;">
            <canvas id="child-preloader-canvas"
                style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></canvas>
            <div id="child-svg-container"
                style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; pointer-events: none; overflow: hidden;">
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1920 1080"
                    class="child-menu-bg-svg origin-center" id="child-logo-svg"
                    style="width: 400px; max-width: 60vw; height: auto; fill: #d4ae6f; opacity: 0; transform: scale(0.5); pointer-events: none;">
                    <path
