        ...
        <div class="w-full flex flex-col px-4 max-w-[1600px] mx-auto z-10 relative">
            ...
            <div class="w-full flex flex-col items-center justify-center text-center mb-8 lg:mb-12" data-aos="fade-up"
                ...
                <div class="overview-title-container mb-6">
                    <h2 class="text-2xl lg:text-4xl font-bold playfair uppercase tracking-wide animate-gradient-text drop-shadow-[0_2px_15px_rgba(212,174,111,0.4)]"
                        id="floor-main-title">
                        Mặt bằng Tầng 1
                    </h2>
            ...
            <div class="w-full relative flex items-center justify-center p-0" data-aos="zoom-in"
                ...
                <div
                    ...
                    <!-- Images -->
                    <a id="floor-img-1" href="<?php echo get_template_directory_uri(); ?>/assets/images/mau-mat-bang-tang-03.png" data-title="Mặt bằng tầng 3-13"
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/mau-mat-bang-tang-03.png"
                            ...
                            alt="Mặt bằng tầng 3-13" loading="lazy" title="Mặt bằng tầng 3-13">
                    </a>
                    <a id="floor-img-2" href="<?php echo get_template_directory_uri(); ?>/assets/images/mau-mat-bang-tang-04.png" data-title="Mặt bằng tầng 14-21"
                    ...
                    <a id="floor-img-3" href="<?php echo get_template_directory_uri(); ?>/assets/images/mau-mat-bang-tang-05.png" data-title="Mặt bằng tầng 22"
                        class="glightbox floor-img absolute inset-0 w-full h-full z-0 opacity-0 scale-95 pointer-events-none">
