            ...
            <div class="bg-[#0e1e2e]/50 backdrop-blur-xl border border-white/10 rounded-3xl p-4 lg:p-6 shadow-[0_20px_50px_rgba(0,0,0,0.3)] flex flex-col gap-6 relative"
                ...
                <div>
                    <p class="text-base md:text-lg text-gray-200 font-light leading-relaxed">
                        ...
                        Suối Tiên) và liền kề Vành đai 3 – trục giao thông huyết mạch của toàn vùng Đông Nam Bộ, đã
                        thông xe kỹ thuật cuối năm 2025, dự kiến sẽ hoàn thành toàn tuyến vào T6/2026.

                        Đồng thời, dự án nằm giữa trung tâm các khu công nghiệp và logistics lớn như KCN Sóng Thần
                        2, ICD Tân Cảng Sóng Thần, KCX Linh Trung 1, Khu Công nghệ cao TP.HCM… và thuộc quy hoạch
                        khu đô thị Thương mại – Dịch vụ, Công nghiệp ứng dụng công nghệ cao quy mô hơn 1.200 ha.
